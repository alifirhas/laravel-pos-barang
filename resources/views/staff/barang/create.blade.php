        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    {{-- Form --}}
                    <form action="{{ route('staff.barangs.store') }}" method="POST">
                        @csrf
                        {{-- Barcode --}}
                        <div class="form-control w-full">
                            ...
                            <input type="text" placeholder="Barcode" name="barcode" maxlength="255"
                                class="input input-bordered w-full" required value="{{ old('barcode') }}" />
                        </div>
                        ...
                        <div class="form-control w-full">
                            ...
                            <input type="text" placeholder="Nama barang" name="nama_barang" maxlength="255"
                                class="input input-bordered w-full" required value="{{ old('nama_barang') }}" />
                        </div>
